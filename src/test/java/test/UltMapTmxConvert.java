...
public class UltMapTmxConvert {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (BaseMap map : ms.getMaps()) {
            ...
            //people layer
            //Person[] people = map.getCity().getPeople();
            Person[] people = getPeopleLayer(map, bytes, mapTileIds, ts);
    ...
    private UltMapTmxConvert(String tilesetName, String imageSource, int mapWidth, int mapHeight,
            int tileWidth, int tileHeight, String data, String people, Person[] persons) {

...
public class TestMain extends Game {
	...
	public void create() {
		...
		try {
			...
			TiledMap tmap = new UltimaTiledMapLoader(Maps.DNG6_CON, a1, Maps.DNG6_CON.getMap().getWidth(), Maps.DNG6_CON.getMap().getHeight(), 16, 16).load();
			CombatScreen sc = new CombatScreen(null, null, context, Maps.WORLD, Maps.DNG6_CON.getMap(), tmap, CreatureType.balron, cs, a1, a1);
